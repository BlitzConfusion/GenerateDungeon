...
public class RoomTest {
    ...
    public void testSetChild() {
        ...
        GateRoom vanhempi = new GateRoom(1);
        FarmRoom lapsi = new FarmRoom(1);
    ...
    public void testSetTwoChildren() {
        ...
        GateRoom vanhempi = new GateRoom(0);
        GateRoom lapsi1 = new GateRoom(1);
        GateRoom lapsi2 = new GateRoom(2);
    ...
    public void testSetThreeChildren() {
        ...
        GateRoom lapsi1 = new GateRoom(1);
        GateRoom lapsi2 = new GateRoom(2);
        GateRoom lapsi3 = new GateRoom(3);
        vanhempi.setChild(lapsi1);
        vanhempi.setChild(lapsi2);
    ...
    public void testIsBetweenExits() {
        ...
        GateRoom gate = new GateRoom(0);
        LibraryRoom lib = new LibraryRoom(0);
        FarmRoom farmi = new FarmRoom(0);
        ExitRoom end = new ExitRoom(0);
        gate.setChild(lib);
        gate.setChild(farmi);
        gate.setChild(end);
